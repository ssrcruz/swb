...
class ScholarshipsControllerTest < ActionController::TestCase
  ...
  test "should create scholarship" do
    assert_difference('Scholarship.count') do
      post :create, scholarship: { major_id: @scholarship.major_id, name: @scholarship.name, school_id: @scholarship.school_id }
    end
  ...
  test "should update scholarship" do
    patch :update, id: @scholarship, scholarship: { major_id: @scholarship.major_id, name: @scholarship.name, school_id: @scholarship.school_id }
    assert_redirected_to scholarship_path(assigns(:scholarship))
  end
